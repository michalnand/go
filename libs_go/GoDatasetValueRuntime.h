#ifndef _GO_DATASET_VALUE_RUNTIME_H_
#define _GO_DATASET_VALUE_RUNTIME_H_
...
class GoDatasetValueRuntime: public DatasetInterface
{
    public:
        GoDatasetValueRuntime(const char* json_file_name);
        GoDatasetValueRuntime(std::string json_file_name);
        GoDatasetValueRuntime(Json::Value json_init);

        virtual ~GoDatasetValueRuntime();
