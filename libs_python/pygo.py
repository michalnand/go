...
class ImageLoad(_object):
    ...
    def __init__(self, *args):
        this = _pygo.new_ImageLoad(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pygo.delete_ImageLoad
    __del__ = lambda self: None

    def load(self, file_name, load_grayscale=False, normalise=False):
        return _pygo.ImageLoad_load(self, file_name, load_grayscale, normalise)

    def get(self):
        return _pygo.ImageLoad_get(self)

    def width(self):
        return _pygo.ImageLoad_width(self)

    def height(self):
        return _pygo.ImageLoad_height(self)

    def channels(self):
        return _pygo.ImageLoad_channels(self)

    def grayscale(self):
        return _pygo.ImageLoad_grayscale(self)

    def normalise_image(self, min=0.0, max=1.0):
        return _pygo.ImageLoad_normalise_image(self, min, max)
ImageLoad_swigregister = _pygo.ImageLoad_swigregister
...
class ImageSave(_object):
    ...
    def __init__(self, width, height, grayscale, display_enabled=False):
        this = _pygo.new_ImageSave(width, height, grayscale, display_enabled)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pygo.delete_ImageSave
    __del__ = lambda self: None

    def save(self, file_name, v):
        return _pygo.ImageSave_save(self, file_name, v)

    def show(self, *args):
        return _pygo.ImageSave_show(self, *args)
ImageSave_swigregister = _pygo.ImageSave_swigregister
...
class JsonConfig(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["result"] = _pygo.JsonConfig_result_set
    __swig_getmethods__["result"] = _pygo.JsonConfig_result_get
    if _newclass:
        result = _swig_property(_pygo.JsonConfig_result_get, _pygo.JsonConfig_result_set)

    def __init__(self, *args):
        this = _pygo.new_JsonConfig(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pygo.delete_JsonConfig
    __del__ = lambda self: None

    def load(self, json_file_name):
        return _pygo.JsonConfig_load(self, json_file_name)

    def save(self, file_name):
        return _pygo.JsonConfig_save(self, file_name)

    def get(self):
        return _pygo.JsonConfig_get(self)
JsonConfig_swigregister = _pygo.JsonConfig_swigregister
...
class Timer(_object):
    ...
    def __init__(self):
        this = _pygo.new_Timer()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pygo.delete_Timer
    __del__ = lambda self: None

    def get_time(self):
        return _pygo.Timer_get_time(self)

    def get_duration(self):
        return _pygo.Timer_get_duration(self)

    def start(self):
        return _pygo.Timer_start(self)

    def stop(self):
        return _pygo.Timer_stop(self)

    def sleep_ms(self, ms_time):
        return _pygo.Timer_sleep_ms(self, ms_time)

    def delay_ms(self, ms_time):
        return _pygo.Timer_delay_ms(self, ms_time)
Timer_swigregister = _pygo.Timer_swigregister
...
class Batch(_object):
    ...
    def __init__(self, *args):
        this = _pygo.new_Batch(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pygo.delete_Batch
    __del__ = lambda self: None

    def create(self, dataset):
        return _pygo.Batch_create(self, dataset)

    def get_input_all(self):
        return _pygo.Batch_get_input_all(self)

    def get_output_all(self):
        return _pygo.Batch_get_output_all(self)
Batch_swigregister = _pygo.Batch_swigregister
...
class DatasetInterface(_object):
    ...
    def __init__(self, *args):
        this = _pygo.new_DatasetInterface(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def get_input_shape(self):
        return _pygo.DatasetInterface_get_input_shape(self)

    def get_output_shape(self):
        return _pygo.DatasetInterface_get_output_shape(self)

    def get_training_count(self):
        return _pygo.DatasetInterface_get_training_count(self)

    def get_testing_count(self):
        return _pygo.DatasetInterface_get_testing_count(self)

    def get_classes_count(self):
        return _pygo.DatasetInterface_get_classes_count(self)

    def set_training_idx(self, idx):
        return _pygo.DatasetInterface_set_training_idx(self, idx)

    def set_random_training_idx(self):
        return _pygo.DatasetInterface_set_random_training_idx(self)

    def get_training_input(self):
        return _pygo.DatasetInterface_get_training_input(self)

    def get_training_output(self):
        return _pygo.DatasetInterface_get_training_output(self)

    def get_training_input_all(self):
        return _pygo.DatasetInterface_get_training_input_all(self)

    def get_training_output_all(self):
        return _pygo.DatasetInterface_get_training_output_all(self)

    def get_testing_input(self, idx):
        return _pygo.DatasetInterface_get_testing_input(self, idx)

    def get_testing_output(self, idx):
        return _pygo.DatasetInterface_get_testing_output(self, idx)

    def get_testing_input_all(self):
        return _pygo.DatasetInterface_get_testing_input_all(self)

    def get_testing_output_all(self):
        return _pygo.DatasetInterface_get_testing_output_all(self)

    def set_input_shape(self, input_shape):
        return _pygo.DatasetInterface_set_input_shape(self, input_shape)

    def set_output_shape(self, output_shape):
        return _pygo.DatasetInterface_set_output_shape(self, output_shape)

    def add_training(self, input, output):
        return _pygo.DatasetInterface_add_training(self, input, output)

    def add_testing(self, input, output):
        return _pygo.DatasetInterface_add_testing(self, input, output)

    def _print(self):
        return _pygo.DatasetInterface__print(self)

    def clear(self):
        return _pygo.DatasetInterface_clear(self)

    def normalise_input(self):
        return _pygo.DatasetInterface_normalise_input(self)

    def normalise_output(self):
        return _pygo.DatasetInterface_normalise_output(self)
...
class DatasetMnist(DatasetInterface):
    ...
    def __init__(self, training_data_file_name, training_labels_file_name, testing_data_file_name, testing_labels_file_name):
        this = _pygo.new_DatasetMnist(training_data_file_name, training_labels_file_name, testing_data_file_name, testing_labels_file_name)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
class ClassificationCompare(_object):
    ...
    def init(self, classes_count, top_n_count=1):
        return _pygo.ClassificationCompare_init(self, classes_count, top_n_count)

    def add(self, target_output, predicted_output):
        return _pygo.ClassificationCompare_add(self, target_output, predicted_output)

    def compute(self):
        return _pygo.ClassificationCompare_compute(self)

    def is_nan_error(self):
        return _pygo.ClassificationCompare_is_nan_error(self)

    def asString(self):
        return _pygo.ClassificationCompare_asString(self)

    def asJson(self):
        return _pygo.ClassificationCompare_asJson(self)

    def get_accuracy(self):
        return _pygo.ClassificationCompare_get_accuracy(self)
...
class ClassificationExperiment(_object):
    ...
    def __init__(self, dataset, experiment_dir, network_config_file):
        this = _pygo.new_ClassificationExperiment(dataset, experiment_dir, network_config_file)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
class sShape(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["w"] = _pygo.sShape_w_set
    __swig_getmethods__["w"] = _pygo.sShape_w_get
    if _newclass:
        w = _swig_property(_pygo.sShape_w_get, _pygo.sShape_w_set)
    __swig_setmethods__["h"] = _pygo.sShape_h_set
    __swig_getmethods__["h"] = _pygo.sShape_h_get
    if _newclass:
        h = _swig_property(_pygo.sShape_h_get, _pygo.sShape_h_set)
    __swig_setmethods__["d"] = _pygo.sShape_d_set
    __swig_getmethods__["d"] = _pygo.sShape_d_get
    if _newclass:
        d = _swig_property(_pygo.sShape_d_get, _pygo.sShape_d_set)

    def __init__(self):
        this = _pygo.new_sShape()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pygo.delete_sShape
    __del__ = lambda self: None
sShape_swigregister = _pygo.sShape_swigregister
...
class Shape(_object):
    ...
    def __init__(self, *args):
        this = _pygo.new_Shape(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pygo.delete_Shape
    __del__ = lambda self: None

    def w(self):
        return _pygo.Shape_w(self)

    def h(self):
        return _pygo.Shape_h(self)

    def d(self):
        return _pygo.Shape_d(self)

    def get(self):
        return _pygo.Shape_get(self)

    def set(self, *args):
        return _pygo.Shape_set(self, *args)

    def size(self):
        return _pygo.Shape_size(self)

    def _print(self):
        return _pygo.Shape__print(self)

    def __eq__(self, *args):
        return _pygo.Shape___eq__(self, *args)

    def __ne__(self, *args):
        return _pygo.Shape___ne__(self, *args)
Shape_swigregister = _pygo.Shape_swigregister
...
class Tensor(_object):
    ...
    def __init__(self, *args):
        this = _pygo.new_Tensor(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pygo.delete_Tensor
    __del__ = lambda self: None

    def w(self):
        return _pygo.Tensor_w(self)

    def h(self):
        return _pygo.Tensor_h(self)

    def d(self):
        return _pygo.Tensor_d(self)

    def size(self):
        return _pygo.Tensor_size(self)

    def shape(self):
        return _pygo.Tensor_shape(self)

    def shape_struct(self):
        return _pygo.Tensor_shape_struct(self)

    def init(self, *args):
        return _pygo.Tensor_init(self, *args)

    def set_from_host(self, *args):
        return _pygo.Tensor_set_from_host(self, *args)

    def set_to_host(self, *args):
        return _pygo.Tensor_set_to_host(self, *args)

    def set_const(self, value):
        return _pygo.Tensor_set_const(self, value)

    def clear(self):
        return _pygo.Tensor_clear(self)

    def set_random(self, range):
        return _pygo.Tensor_set_random(self, range)

    def set(self, x, y, z, value):
        return _pygo.Tensor_set(self, x, y, z, value)

    def get(self, x, y, z):
        return _pygo.Tensor_get(self, x, y, z)

    def _print(self):
        return _pygo.Tensor__print(self)

    def save(self, file_name):
        return _pygo.Tensor_save(self, file_name)

    def load(self, file_name):
        return _pygo.Tensor_load(self, file_name)

    def is_valid(self):
        return _pygo.Tensor_is_valid(self)

    def add(self, rhs):
        return _pygo.Tensor_add(self, rhs)

    def sub(self, rhs):
        return _pygo.Tensor_sub(self, rhs)

    def mul(self, value):
        return _pygo.Tensor_mul(self, value)

    def concatenate(self, ta, tb):
        return _pygo.Tensor_concatenate(self, ta, tb)

    def split(self, ta, tb):
        return _pygo.Tensor_split(self, ta, tb)
    __swig_setmethods__["v"] = _pygo.Tensor_v_set
    __swig_getmethods__["v"] = _pygo.Tensor_v_get
    if _newclass:
        v = _swig_property(_pygo.Tensor_v_get, _pygo.Tensor_v_set)
Tensor_swigregister = _pygo.Tensor_swigregister
...
class CNN(_object):
    ...
    def get_input_shape(self):
        return _pygo.CNN_get_input_shape(self)

    def get_output_shape(self):
        return _pygo.CNN_get_output_shape(self)
    ...
    def is_training_mode(self):
        return _pygo.CNN_is_training_mode(self)

    def reset(self):
        return _pygo.CNN_reset(self)

    def add_layer(self, *args):
        return _pygo.CNN_add_layer(self, *args)

    def asString(self):
        return _pygo.CNN_asString(self)

    def _print(self):
        return _pygo.CNN__print(self)

    def save(self, path):
        return _pygo.CNN_save(self, path)

    def load_weights(self, file_name_prefix):
        return _pygo.CNN_load_weights(self, file_name_prefix)

    def get_layer_output_size(self):
        return _pygo.CNN_get_layer_output_size(self)

    def get_layer_output(self, layer_idx):
        return _pygo.CNN_get_layer_output(self, layer_idx)

    def get_layer_weights_flag(self, layer_idx):
        return _pygo.CNN_get_layer_weights_flag(self, layer_idx)
...
class CNNVisualisation(_object):
    ...
    def __init__(self, nn):
        this = _pygo.new_CNNVisualisation(nn)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pygo.delete_CNNVisualisation
    __del__ = lambda self: None

    def process(self):
        return _pygo.CNNVisualisation_process(self)

    def save(self, file_name_prefix):
        return _pygo.CNNVisualisation_save(self, file_name_prefix)
CNNVisualisation_swigregister = _pygo.CNNVisualisation_swigregister
...
class ExperienceReplayBuffer(_object):
    ...
    def __init__(self, *args):
        this = _pygo.new_ExperienceReplayBuffer(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pygo.delete_ExperienceReplayBuffer
    __del__ = lambda self: None

    def init(self, buffer_size, state_size, actions_count):
        return _pygo.ExperienceReplayBuffer_init(self, buffer_size, state_size, actions_count)

    def add(self, state, q_values, action, reward, terminal=False):
        return _pygo.ExperienceReplayBuffer_add(self, state, q_values, action, reward, terminal)

    def is_full(self):
        return _pygo.ExperienceReplayBuffer_is_full(self)

    def compute(self, gamma=0.99, clamp_value=10.0):
        return _pygo.ExperienceReplayBuffer_compute(self, gamma, clamp_value)

    def size(self):
        return _pygo.ExperienceReplayBuffer_size(self)

    def _print(self):
        return _pygo.ExperienceReplayBuffer__print(self)

    def get_state(self):
        return _pygo.ExperienceReplayBuffer_get_state(self)

    def get_q_values(self):
        return _pygo.ExperienceReplayBuffer_get_q_values(self)

    def get_action(self):
        return _pygo.ExperienceReplayBuffer_get_action(self)

    def get_reward(self):
        return _pygo.ExperienceReplayBuffer_get_reward(self)

    def get_terminal(self):
        return _pygo.ExperienceReplayBuffer_get_terminal(self)
ExperienceReplayBuffer_swigregister = _pygo.ExperienceReplayBuffer_swigregister
...
class DQN(_object):
    ...
    def init(self, *args):
        return _pygo.DQN_init(self, *args)

    def add_layer(self, *args):
        return _pygo.DQN_add_layer(self, *args)

    def forward(self, state):
        return _pygo.DQN_forward(self, state)

    def get_q_values(self):
        return _pygo.DQN_get_q_values(self)

    def add(self, state, q_values, action, reward, terminal=False):
        return _pygo.DQN_add(self, state, q_values, action, reward, terminal)

    def is_full(self):
        return _pygo.DQN_is_full(self)

    def train(self):
        return _pygo.DQN_train(self)

    def _print(self):
        return _pygo.DQN__print(self)

    def print_buffer(self):
        return _pygo.DQN_print_buffer(self)

    def save(self, path):
        return _pygo.DQN_save(self, path)

    def load_weights(self, file_name_prefix):
        return _pygo.DQN_load_weights(self, file_name_prefix)
...
class DQNA(_object):
    ...
    def __init__(self, *args):
        this = _pygo.new_DQNA(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pygo.delete_DQNA
    __del__ = lambda self: None
    ...
    def init(self, state_shape, actions_count, gamma, replay_buffer_size, features_network_config_file_name, reconstruction_network_config_file_name, q_network_config_file_name):
        return _pygo.DQNA_init(self, state_shape, actions_count, gamma, replay_buffer_size, features_network_config_file_name, reconstruction_network_config_file_name, q_network_config_file_name)

    def forward(self, state):
        return _pygo.DQNA_forward(self, state)

    def get_q_values(self):
        return _pygo.DQNA_get_q_values(self)

    def add(self, state, q_values, action, reward, terminal=False):
        return _pygo.DQNA_add(self, state, q_values, action, reward, terminal)

    def is_full(self):
        return _pygo.DQNA_is_full(self)

    def train(self):
        return _pygo.DQNA_train(self)

    def _print(self):
        return _pygo.DQNA__print(self)

    def print_buffer(self):
        return _pygo.DQNA_print_buffer(self)

    def save(self, path):
        return _pygo.DQNA_save(self, path)

    def load_weights(self, file_name_prefix):
        return _pygo.DQNA_load_weights(self, file_name_prefix)
DQNA_swigregister = _pygo.DQNA_swigregister
...
class LayerExport(_object):
    ...
    def __init__(self, export_path, json, layer_prefix, input_shape, output_shape):
        this = _pygo.new_LayerExport(export_path, json, layer_prefix, input_shape, output_shape)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pygo.delete_LayerExport
    __del__ = lambda self: None

    def get(self):
        return _pygo.LayerExport_get(self)

    def save(self):
        return _pygo.LayerExport_save(self)
LayerExport_swigregister = _pygo.LayerExport_swigregister
...
class EmbeddedNetworkTest(_object):
    ...
    def __init__(self, dataset, nn):
        this = _pygo.new_EmbeddedNetworkTest(dataset, nn)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pygo.delete_EmbeddedNetworkTest
    __del__ = lambda self: None

    def process(self):
        return _pygo.EmbeddedNetworkTest_process(self)
EmbeddedNetworkTest_swigregister = _pygo.EmbeddedNetworkTest_swigregister
...
class EmbeddedNetworkExport(_object):
    ...
    def __init__(self, trained_config_file_name):
        this = _pygo.new_EmbeddedNetworkExport(trained_config_file_name)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pygo.delete_EmbeddedNetworkExport
    __del__ = lambda self: None

    def process(self, export_path, network_prefix):
        return _pygo.EmbeddedNetworkExport_process(self, export_path, network_prefix)
EmbeddedNetworkExport_swigregister = _pygo.EmbeddedNetworkExport_swigregister
...
class sGoDatasetItem(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, sGoDatasetItem, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, sGoDatasetItem, name)
    __repr__ = _swig_repr
    __swig_setmethods__["input"] = _pygo.sGoDatasetItem_input_set
    __swig_getmethods__["input"] = _pygo.sGoDatasetItem_input_get
    if _newclass:
        input = _swig_property(_pygo.sGoDatasetItem_input_get, _pygo.sGoDatasetItem_input_set)
    __swig_setmethods__["output"] = _pygo.sGoDatasetItem_output_set
    __swig_getmethods__["output"] = _pygo.sGoDatasetItem_output_get
    if _newclass:
        output = _swig_property(_pygo.sGoDatasetItem_output_get, _pygo.sGoDatasetItem_output_set)

    def __init__(self):
        this = _pygo.new_sGoDatasetItem()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pygo.delete_sGoDatasetItem
    __del__ = lambda self: None
sGoDatasetItem_swigregister = _pygo.sGoDatasetItem_swigregister
sGoDatasetItem_swigregister(sGoDatasetItem)
...
class GoDatasetRuntime(DatasetInterface):
    ...
    def get_training_count(self):
        return _pygo.GoDatasetRuntime_get_training_count(self)

    def get_testing_count(self):
        return _pygo.GoDatasetRuntime_get_testing_count(self)

    def get_classes_count(self):
        return _pygo.GoDatasetRuntime_get_classes_count(self)

    def set_random_training_idx(self):
        return _pygo.GoDatasetRuntime_set_random_training_idx(self)

    def get_training_input(self):
        return _pygo.GoDatasetRuntime_get_training_input(self)

    def get_training_output(self):
        return _pygo.GoDatasetRuntime_get_training_output(self)

    def get_testing_input(self, idx):
        return _pygo.GoDatasetRuntime_get_testing_input(self, idx)

    def get_testing_output(self, idx):
        return _pygo.GoDatasetRuntime_get_testing_output(self, idx)
...
class GoSupervised(ClassificationExperiment):
    ...
    def __init__(self, dataset, experiment_dir, network_config_file):
        this = _pygo.new_GoSupervised(dataset, experiment_dir, network_config_file)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
